  ...
  return <section className="section-padding relative overflow-hidden" id="demo-video">
      <div className="container mx-auto px-6">
        <div className="max-w-3xl mx-auto text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">Transforming Healthcare Claims With Advanced AI</h2>
        ...
        <div className="relative rounded-2xl overflow-hidden cyber-border">
          <div className="aspect-w-16 aspect-h-9 w-full">
            <iframe ref={videoRef} title="Health Insurance Claims GPT Demo" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen className="w-full h-full" loading="lazy" onLoad={() => setIsLoaded(true)}></iframe>
          </div>
